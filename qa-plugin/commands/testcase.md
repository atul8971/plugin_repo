...
1. Use the Task tool with `subagent_type='google-sheets-manager'` to:
   ...
   - Write new test cases extracted from Jira or generated by test-generator
   - Update test execution status
   - Create new sheets for test documentation
   - Append test results or metrics
...
- Structure new test cases into Google Sheets format (Test ID, Category, Objective, Steps, Expected Results, Test Data, Status)
